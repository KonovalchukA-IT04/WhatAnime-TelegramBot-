...
{
    public class SearchTheManga : Command
    {
        public override string Name => "searchmanga";
        public override async Task Execute(ResponseInfo.Message message, TelegramBotClient client)
        {
            ...
            var resp = Connections.Find.Response("https://whatanimetelegrambot.azurewebsites.net/api/", "manga/name/", messageText).Result;
