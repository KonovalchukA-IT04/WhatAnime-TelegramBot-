...
{
    public class AnimeId : Command
    {
        public override string Name => "animeid";
        public override async Task Execute(ResponseInfo.Message message, TelegramBotClient client)
        {
            ...
            var resp = Connections.Find.Response("https://whatanimetelegrambot.azurewebsites.net/api/", "anime/id/", messageText).Result;
